...
from terraCOP.logger import Logger

from terraCOP.python_tf.tfstate import Tfstate
...
class Terraform(object):
    ...
    def __getattr__(self, item):
        def wrapper(*args, **kwargs):
            ...
            return self.cmd(cmd_name, 'output' *args, **kwargs)
    ...
    def cmd(self, cmd, type:str='', *args, **kwargs):
        """
        ...
        new_out = out.splitlines()
        last_line = ''
        for line in new_out:
            if 'Apply complete!' in str(line) or 'Destroy complete!' in str(line):
                last_line = str(line)[1:].replace('\\n', '')
